...
//       <server mode> Java Servent1 server 
//       <user mode> Java Servent1 user 
//
...
public class Servent1 extends Thread {
    ...
    public static final int BUFSIZE = 1024;
	 ...
	 public String Mode;
	 public final String dirpath="E:\\Navanee\\JGrasp Projects\\Consistent Gnutella\\test\\Servent1\\Master\\";
	 public final String recvdir="E:\\Navanee\\JGrasp Projects\\Consistent Gnutella\\test\\Servent1\\Recievedfiles\\";
		  ...
		  {	
			...
			else if(entry_mode.equals("USER"))
			{
				try {
					...
					System.out.println("***************** Servent1 User Interface ******************  ");  
