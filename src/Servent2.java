...
//       <server mode> Java Servent2 server 
//       <user mode> Java Servent2 user 
//
...
public class Servent2 extends Thread {
    ...
    public static final int BUFSIZE = 1024;
	 ...
	 public String Mode;
	 public final String dirpath="E:\\Navanee\\JGrasp Projects\\Consistent Gnutella\\test\\Servent2\\Master\\";
	 public final String recvdir="E:\\Navanee\\JGrasp Projects\\Consistent Gnutella\\test\\Servent2\\Recievedfiles\\";
		  ...
		  {	
			...
			else if(entry_mode.equals("USER"))
			{
				try {
					...
					System.out.println("***************** Servent2 User Interface ******************  ");  
