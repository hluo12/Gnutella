...
//       <server mode> Java Servent4 server 
//       <user mode> Java Servent4 user 
//
...
public class Servent4 extends Thread {
    ...
    public static final int BUFSIZE = 1024;
	 ...
	 public String Mode;
	 public final String dirpath="E:\\Navanee\\JGrasp Projects\\Consistent Gnutella\\test\\Servent4\\Master\\";
	 public final String recvdir="E:\\Navanee\\JGrasp Projects\\Consistent Gnutella\\test\\Servent4\\Recievedfiles\\";
		  ...
		  {	
			...
			else if(entry_mode.equals("USER"))
			{
				try {
					...
					System.out.println("***************** Servent4 User Interface ******************  ");  
